...
![last_updated_23072023](https://img.shields.io/badge/last%20updated-23%20July%202023-yellow)
...
8. In the "Add to a Dashboard In This Folder" pop-up, set the title to:
    ...
    ```
    Click **New Dashboard** and enter`<Board Name>` (replace it with the name given in the line "Place this in a new Dashboard named ___") at the pop-up prompt. Then click **OK**, then **Save to Dashboard**.
...
3. Go to **Folders** > **My Folder** > `<Board Name>`, then play around with the dashboard as you like.
